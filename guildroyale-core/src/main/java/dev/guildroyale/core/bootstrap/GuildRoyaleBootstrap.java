package dev.guildroyale.core.bootstrap;

import dev.guildroyale.core.command.GuildAdminCommandRegistrar;
import dev.guildroyale.core.command.GuildCommandRegistrar;
