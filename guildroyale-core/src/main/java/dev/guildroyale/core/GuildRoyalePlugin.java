package dev.guildroyale.core;

import dev.guildroyale.api.service.GuildService;
import dev.guildroyale.api.service.LeaderboardService;
import dev.guildroyale.api.service.MemberService;
import dev.guildroyale.api.service.RoleService;
import dev.guildroyale.api.storage.GuildRepository;
import dev.guildroyale.core.config.ConfigManager;
import dev.guildroyale.core.config.MessagesManager;
import dev.guildroyale.core.dialog.DialogManager;
import dev.guildroyale.core.gui.GuiManager;
import dev.guildroyale.core.integration.GuildRoyalePlaceholderExpansion;
import dev.guildroyale.core.listener.GuildEventListener;
import dev.guildroyale.core.listener.GuiListener;
import dev.guildroyale.core.listener.PlayerQuitListener;
import dev.guildroyale.core.logging.GuildLogWriter;
import dev.guildroyale.core.scheduler.FoliaScheduler;
import dev.guildroyale.core.service.*;
import dev.guildroyale.core.storage.StorageFactory;
